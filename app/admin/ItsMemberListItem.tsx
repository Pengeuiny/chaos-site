...
import { updateItsMember, deleteItsMember, moveItsMember } from "./people-actions";
...
export default function ItsMemberListItem({
  person,
  isFirst,
  isLast,
  canEdit,
    ...
    return (
      <li className={styles.eventItem} style={{ display: "block" }}>
        <form action={updateItsMember} className={styles.form} style={{ gap: 10 }}>
          ...
          <label className={styles.label}>
            <span>Contact email <span className={styles.hint}>(optional)</span></span>
            <input
              className={styles.input}
              type="email"
              name="email"
